...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  const d = res.data
  if (!d?.username) throw `❌ Akun *@${username}* tidak ditemukan`
...
export const tiktokStalkHandler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  if (!res.data?.status || !res.data?.user?.user) throw `❌ Username *@${username}* tidak ditemukan`
...
export const githubStalkHandler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  if (!d?.login) throw `❌ User *${username}* tidak ditemukan`
...
export const ytStalkHandler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  if (!item) throw `❌ Channel tidak ditemukan`
