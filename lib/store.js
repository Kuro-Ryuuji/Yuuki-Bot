/**
 * @param {import('ourin-baileys').WASocket | import('ourin-baileys').WALegacySocket}
 */
function bind(conn) {
    if (!conn.chats) conn.chats = {}
    /**
     * 
     * @param {import('ourin-baileys').Contact[]|{contacts:import('ourin-baileys').Contact[]}} contacts 
     * @returns 
     */
